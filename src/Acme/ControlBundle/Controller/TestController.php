...
namespace Acme\ControlBundle\Controller;
...
use Acme\ControlBundle\Entity\Test;
use Acme\ControlBundle\Form\TestType;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeControlBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeControlBundle:Test:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeControlBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeControlBundle:Test:edit.html.twig")
     */
